...
class Login
{
    ...
    private function dologinWithPostData()
    {
        ...
        $openingAlert = "<h1>";
        $closingAlert = "</h1><p class='lead'>please try again.</p>";
        ...
        if (empty($_POST['user_name'])) {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                // username field)
                $sql = "SELECT user_id, user_name, user_email, user_password_hash, user_last, user_account_type, user_date_joined, user_first
                        FROM users
                ...
                if ($result_of_login_check->num_rows == 1) {
                    ...
                    if (password_verify($_POST['user_password'], $result_row->user_password_hash)) {
                        ...
                        $this->errors[] = $openingAlert . "Wrong password.</div>" . $closingAlert;
                    }
                } else {
